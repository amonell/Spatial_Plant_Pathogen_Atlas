...
additional_urls = [
    "http://neomorph.salk.edu/download/Nobori_etal_merfish/MERFISH/Baysor_segmentations/avrrpt24/segmentation2_cell_stats.csv",
...
for url in additional_urls:
    download_directory = os.path.join(
        "data", "segmentations", os.path.basename(os.path.dirname(url))
    )
    print(download_directory)
    # Ensure the download directory exists
    if not os.path.exists(download_directory):
...
# downloading objects
useful_files = [
    "http://neomorph.salk.edu/download/Nobori_etal_merfish/MERFISH/DC3000_alone.rds",
    "http://neomorph.salk.edu/download/Nobori_etal_merfish/MERFISH/AvrRpt2_alone.rds",
    "http://neomorph.salk.edu/download/Nobori_etal_merfish/MERFISH/AvrRpt2_alone2.rds",
]
